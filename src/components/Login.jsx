            ...
            <div className="card bg-base-100 p-7  w-full max-w-sm shrink-0 shadow-2xl">
                ...
                <div className="card-body">
                    <form className="fieldset">
                        ...
                        <input type="email" className="input border-primary" placeholder="Email" />
                        <label className="label">Password</label>
                        <input type="password" className="input border-primary" placeholder="Password" />
                        <div><a className="link link-hover">Forgot password?</a></div>
                        <button className="btn bg-[#0967C2] text-white border-[#0059b3]">Login</button>
                        {/* Google */}
